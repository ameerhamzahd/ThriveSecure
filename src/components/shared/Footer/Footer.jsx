...
const Footer = () => {
    ...
    return (
        <footer className="footer lg:footer-horizontal bg-gradient-to-br from-teal-200 via-teal-100 to-teal-50 backdrop-blur-lg text-base-content p-10 mt-15 lg:mt-20 max-w-11/12 mx-auto mb-5 rounded-3xl">
            <aside>
