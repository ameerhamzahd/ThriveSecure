...
import { FaFilter, FaSearch, FaTags, FaArrowRight, FaSort } from "react-icons/fa";
...
const AllPolicies = () => {
  ...
  let filteredPolicies = selectedCategory === "All"
    ? policies
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-6">
          ...
          <select
            ...
            className="px-4 py-2 rounded-full border bg-white text-gray-700 hover:bg-blue-50"
          >
